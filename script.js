...
start.onclick = function () {
	...
	if (bool === true) {
		...
		let int;
		arr = getRundomFigure();
		document.getElementById(arr[0][0]).style.backgroundColor = "rgba(106, 211, 99, 0.44)";
		document.getElementById(arr[0][1]).style.backgroundColor = "rgba(106, 211, 99, 0.44)";
		document.getElementById(arr[0][2]).style.backgroundColor = "rgba(106, 211, 99, 0.44)";
		document.getElementById(arr[0][3]).style.backgroundColor = "rgba(106, 211, 99, 0.44)";
